...
class DriverRepositoryImpl implements DriverRepository {
  ...
  Future<Either<Failure, DriverModel>> getDriver({
    ...
    if (await networkInfo.isConnected!) {
      try {
        final remoteDriver = await remoteDataSource.getDriver(
        ...
        return Left(ServerFailure(message: 'This is a server exception'));
      }
    } else {
      try {
        ...
        return Left(CacheFailure('This is a cache exception'));
      }
    }
  }
}
