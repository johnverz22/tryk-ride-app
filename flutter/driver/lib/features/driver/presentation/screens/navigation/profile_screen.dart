import 'package:driver/features/driver/presentation/screens/navigation/profile/driver_id_verification_screen.dart';
import 'package:flutter/material.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';
import '../../providers/driver_provider.dart';
import 'menu/logout_delete_account_dialogs.dart';
import 'menu/personal_info_screen.dart';
import 'menu/notifications_preferences_screen.dart';
import 'menu/payment_methods_screen.dart';
import 'menu/privacy_settings_screen.dart';
import 'menu/language_settings_screen.dart';
import 'menu/preferred_drivers_screen.dart';
import 'menu/vehicle_preferences_screen.dart';
import 'menu/special_requirements_screen.dart';
...
class ProfileScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final userState = ref.watch(driverProvider);
